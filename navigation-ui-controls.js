(()=>{
  ...
  function init(){
    ...
    if(!root||!close||!center||!maneuver)return false;if(root.dataset.compactNavUi==='6')return true;root.dataset.compactNavUi='6';
    ...
    function renderState(){
      if(northView){center.innerHTML=compassIcon;center.setAttribute('aria-label','Wróć do nawigacji');center.title='Wróć do nawigacji'}
      else{center.innerHTML=navIcon;center.setAttribute('aria-label','Widok na północ');center.title='Widok na północ'}
    }
