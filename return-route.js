(()=>{
  ...
  emptySwitch.addEventListener('change',()=>{emptyRun=emptySwitch.checked;body.dataset.emptyRun=emptyRun?'1':'';applyDirection();body.dispatchEvent(new CustomEvent('route-mode-change',{bubbles:true,detail:{direction,emptyRun}}))});
