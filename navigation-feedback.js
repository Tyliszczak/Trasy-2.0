(()=>{
  ...
  style.textContent=`
    ...
    body.routeFeedbackNavigation #routeFeedbackButton{position:absolute;left:12px;right:auto;top:auto;bottom:96px}
  ...
  function updatePosition(){
    ...
    const target=navVisible&&canvas?canvas:document.body;
