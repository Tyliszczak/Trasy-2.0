(()=>{
  ...
  style.textContent=`
    ...
    #routeMapSpeedBox{position:absolute;left:12px;bottom:12px;z-index:50100;display:flex;align-items:flex-end;gap:8px;padding:7px 8px;border-radius:12px;background:#111c;box-shadow:0 2px 9px #0009;pointer-events:none}
    ...
    @media(max-width:520px){#scheduleSpeedBox{gap:7px}#scheduleSpeedBox .routeSpeedLimit{width:48px;height:48px;font-size:20px;border-width:4px}#scheduleSpeedBox .routeCurrentSpeed{min-width:60px;font-size:27px}#routeMapSpeedBox{left:10px;bottom:10px}}
  `;
