...
const CACHE_NAME='trasy-2.0-v196';
const OFFLINE_MAP_CACHE='trasy-offline-map-v1';
const OFFLINE_ROUTE_CACHE='trasy-offline-routes-v1';
const APP_SHELL=['./','./index.html','./style.css','./time-core.js','./geo-core.js','./eta-core.js','./route-data-service.js','./parking-data.js','./gps-hub.js','./gps-stop-engine.js','./stop-target-policy.js','./stop-alert-core.js','./schedule-time.js','./app.js','./app-update-check.js','./wake-style.js','./maplibre-route-hook.js','./offline-map-cache.js','./offline-route-cache.js','./vehicles.js','./return-route.js','./speed-display.js','./road-speed-limit-core.js','./road-speed-limit.js','./navigation-live-core.js','./navigation-live-engine.js','./return-gps-mode.js','./gps-stop-tracker.js','./return-start-guard.js','./google-routes-provider.js','./return-start-navigation.js','./nav-map.js','./maneuver-bubble.js','./route-progress-core.js','./route-progress-style.js','./map-theme-core.js','./ptv-basemap.js','./map-day-night.js','./traffic-delay-ui.js','./navigation-ui-controls.js','./map-night-ui.js','./navigation-compass.js','./navigation-feedback.js','./android-back-navigation.js','./etoll-overlay.js','./skip-stop-control.js','./skip-detection.js','./final-stop-ui.js','./stop-map-links.js','./eta-status.js','./next-stop-header.js','./return-start-header-fix.js','./eta-clock-ui.js','./visual-stop-alert.js','./routes.js','./schedule.js','./manifest.json','./Tyliszczak.png'];
