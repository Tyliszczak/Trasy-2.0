...
- VMAX korzysta wyłącznie z OpenStreetMap; brak danych OSM nie uruchamia żadnego płatnego źródła zapasowego,
- klucz PTV nie trafia do PWA i służy wyłącznie mapie dziennej po stronie funkcji Cloudflare, nie ustalaniu VMAX,
